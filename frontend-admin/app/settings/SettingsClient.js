  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#07090e] text-slate-900 dark:text-white font-jakarta">
      ...
      <main className="pt-28 pb-20 px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-orange-500/10 via-amber-500/5 to-transparent border border-orange-500/20 rounded-2xl p-5 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm">
          ...
          {platformSupportWhatsapp && (
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold transition shadow-md shadow-emerald-600/20 shrink-0 w-fit"
            >
        ...
        {loading ? (
          ...
          <form onSubmit={handleSubmit} className="bg-white dark:bg-[#10141f] border border-slate-200 dark:border-white/10 rounded-2xl p-6 md:p-8 shadow-sm space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase mb-1.5">
                  Restaurant Name
                </label>
                <div className="flex items-center bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 focus-within:border-orange-500 transition">
                  <Building className="text-slate-400 dark:text-slate-500 w-5 h-5 mr-3 shrink-0" />
                  <input
                    type="text"
                    value={form.name}
                    onChange={(e) => setForm({ ...form, name: e.target.value })}
                    required
                    className="w-full bg-transparent text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 text-sm outline-none"
                  />
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 outline-none focus:border-orange-500 transition"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 focus-within:border-orange-500 transition">
                  <Utensils className="text-slate-400 dark:text-slate-500 w-5 h-5 mr-3 shrink-0" />
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="flex items-center bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 focus-within:border-orange-500 transition">
                  <Clock className="text-slate-400 dark:text-slate-500 w-5 h-5 mr-3 shrink-0" />
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="flex items-center bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 focus-within:border-orange-500 transition">
                  <Phone className="text-slate-400 dark:text-slate-500 w-5 h-5 mr-3 shrink-0" />
                  <input
                    type="text"
                    value={form.phone}
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase mb-1.5 flex items-center justify-between">
                  <span>WhatsApp Number (Optional)</span>
                  <span className="text-[10px] text-slate-400 normal-case font-normal">Customer chat link</span>
                </label>
                <div className="flex items-center bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 focus-within:border-emerald-500 transition">
              ...
              <div>
                ...
                <div className="flex items-center bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 focus-within:border-orange-500 transition">
                  <Mail className="text-slate-400 dark:text-slate-500 w-5 h-5 mr-3 shrink-0" />
                  <input
                    type="email"
                    value={form.email}
            ...
            <div className="pt-4 flex justify-end">
              <button
                type="submit"
                disabled={saving}
                className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-white font-bold px-6 py-2.5 rounded-xl text-sm transition shadow-md shadow-orange-500/20"
              >
                <Save size={16} />

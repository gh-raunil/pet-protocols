        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="flex gap-10 justify-between w-60% md:w-50%">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                <Link href="/about" className="text-brand-muted text-sm hover:text-brand-orange transition">FAQs & Info</Link>
                <Link href="/about" className="text-brand-muted text-sm hover:text-brand-orange transition">Platform Policy</Link>
                <Link href="/about" className="text-brand-muted text-sm hover:text-brand-orange transition">Terms of Service</Link>
                <Link href="/orders" className="text-brand-muted text-sm hover:text-brand-orange transition">Track Order</Link>
                <Link href="/contact" className="text-brand-muted text-sm hover:text-brand-orange transition">Help Center</Link>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-brand-muted hover:text-brand-orange transition">
                <Instagram size={20} />
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-brand-muted hover:text-brand-orange transition">
                <Facebook size={20} />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-brand-muted hover:text-brand-orange transition">
                <YouTube size={20} />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-brand-muted hover:text-brand-orange transition">
                <Twitter size={20} />
              </a>
            </div>
          </div>

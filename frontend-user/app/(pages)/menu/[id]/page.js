    ...
    <div className="min-h-screen bg-black text-white mt-10">
      <div className="max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-2 gap-16 items-start">
        ...
        <div className="sticky top-24">
          <div className="relative rounded-3xl overflow-hidden bg-[#111] h-[420px] w-full">
            <Image
            ...
            {!product.isAvailable && (
              <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px] z-10 flex flex-col items-center justify-center">
                <span className="px-4 py-2 rounded-full bg-red-600/90 text-white text-sm font-black uppercase tracking-wider shadow-xl border border-red-400/30">
                  Out of Stock
                </span>
                <span className="text-xs text-white/70 font-medium mt-1.5">
                  This item is currently unavailable to order
                </span>
              </div>
            )}
